...
export interface CancelTurnByEmployeeOutput {
  cancelled: true;
  turnId: string;
}

export class CancelTurnByEmployeeUseCase
  implements UseCase<CancelTurnByEmployeeInput, CancelTurnByEmployeeOutput>
{
  public constructor(
