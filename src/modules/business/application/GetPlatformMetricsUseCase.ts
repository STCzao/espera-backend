...
/**
 * Platform-wide metrics for the Backoffice dashboard (HU-8.5). Unlike
 * GetQueueMetricsUseCase (Épica 3), which scopes to a single Queue, this
 * aggregates across every Business/Turn in the system.
 */
